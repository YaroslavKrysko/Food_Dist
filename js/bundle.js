...
_services_services__WEBPACK_IMPORTED_MODULE_0__.getResource.get('http://localhost:3000/menu')
	.then(data => {
...
const modalTimerId = setTimeout(()=> (0,_modules_modals__WEBPACK_IMPORTED_MODULE_1__.openModal)('.modal', modalTimerId), 300000);
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2026-06-11');
